...
const Forecast = ({data}) => {
    ...
    return (
        <>
            <label className="title">Forecast in city {data.city.name}</label>
                        ...
                        <AccordionItemHeading>
                            <AccordionItemButton>
                                <div className="daily-item">
                                    ...
                                    <label
                                        className="description">{(item.weather[0].description).charAt(0).toUpperCase() + (item.weather[0].description).slice(1)}</label>
